...
Cardiomyocytes
```{r}
VlnPlot(xenium.obj.female, c("Mylk3", "Trdn", "Hrc", "Myoz2"), pt.size = 0)
```
...
```{r}
FeaturePlot(xenium.obj.female, c("Aqp7", "Timp4"), label = T)
```
...
To highlight musclecontraction cluster spatially
```{r}
