...
write.csv(markers_orab1, file = "../r_objects/markers_ORAB2_female.csv", quote = F)
```
...
```{r}
niche_bar_mi_orab <- data.frame(niche_female_mi_abs[,"1"], niche_female_orab1_abs[,"4"])
...
```{r}
niche_bar_mi_orab <- data.frame(niche_female_mi_abs[,"2"], niche_female_orab1_abs[,"3"])
colnames(niche_bar_mi_orab) <- c("MI", "ORAB1")
niche_bar_mi_orab$celltype <- rownames(niche_bar_mi_orab)
niche_bar_mi_orab_melt <- melt(niche_bar_mi_orab)
