...
```{r}
cells_female_seg <- read.csv(gzfile("/prj/XeniumProbeDesign/mouse_heart_03012025/output-XETG00046__0046388__Region_1__20241219__110827/qupath_seg/outs/cells.csv.gz")) 
...
for (each_set in names(list_genes_DE_per_condition)){
  print(each_set)
  gostres <- gost(query = list_genes_DE_per_condition[[each_set]], organism = "mmusculus")
