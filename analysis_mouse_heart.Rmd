...
The niche that drastically changes is niche 2 from MI i.e. niche 4 in ORAB1. 
Plot the cellcular percentages for these two niches as barplots
```{r}
niche_bar_mi_orab <- data.frame(niche_female_mi_abs[,"2"], niche_female_orab1_abs[,"4"])
