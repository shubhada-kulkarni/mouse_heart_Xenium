...
```{r}
ImageDimPlot(xenium.obj.female_wt_niche, group.by = "niches", size = 1.5, dark.background = F, flip_xy = F) + ggtitle("Niches") | ggplot(niche_female_wt_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black")  + theme(legend.position="none")  + xlab("niches") | ggplot(niche_female_wt_abs_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black") + xlab("niches") 
```
...
```{r}
ImageDimPlot(xenium.obj.female_mi_niche, group.by = "niches", size = 1.5, dark.background = F, flip_xy = F) + ggtitle("Niches") | ggplot(niche_female_mi_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black")  + theme(legend.position="none")  + xlab("niches") | ggplot(niche_female_mi_abs_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black") + xlab("niches") 
```
...
```{r}
ImageDimPlot(xenium.obj.female_orab1_niche, group.by = "niches", size = 1.5, dark.background = F, flip_xy = F) + ggtitle("Niches") | ggplot(niche_female_orab1_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black")  + theme(legend.position="none")  + xlab("niches") | ggplot(niche_female_orab1_abs_melt, aes(x=Var2, y=value, fill=Var1)) + geom_bar(stat = "identity", colour = "black") + xlab("niches") 
```
...
```{r}
ImageDimPlot(xenium.obj.female_mi_niche, group.by = "niches", size = 1.5, dark.background = F, flip_xy = F) | ImageDimPlot(xenium.obj.female_orab1_niche, group.by = "niches", size = 1.5, dark.background = F, flip_xy = F)
```
